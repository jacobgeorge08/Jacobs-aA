...
//Above function tests wether a number is 5 or not
...
//Above function tests wether a function is orr or not
...
//Above functions lists all numbers between the min and max ranges while taking a `step` jump and returns them in an array
